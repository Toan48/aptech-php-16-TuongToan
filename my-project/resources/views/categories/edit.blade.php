                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" action="{{route('category.update', $category->id)}}" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_method" value="post" />> {{csrf_field()}}
                                    <div class="form-group">
                                        <label>categories name</label>
                                        <input type="text" class="form-control form-control-line" name="name" value="{{$category->name}}">
                                    </div>
