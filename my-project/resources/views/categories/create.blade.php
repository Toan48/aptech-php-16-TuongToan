                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Giao diện trang thêm mới danh mục sản phẩm</h6>
                                <form class="form-material m-t-40" action="{{route('category.store')}}" method="post" enctype="multipart/form-data">
